...
exports.generateMasterTemplate = (config = {}) => {
  ...
  // 🟢 Green: Positive actions (Approved, Success, Activated, Unblocked)
  // 🔴 Red: Negative actions (Rejected, Failed, Deactivated, Blocked)
  // 🟡 Yellow: Pending/In-progress actions (Pending, Submitted)
