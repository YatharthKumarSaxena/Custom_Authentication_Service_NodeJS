...
const hardDeleteAccountFieldPresenceMiddleware = checkBodyPresence("hardDeleteAccountFieldPresence",hardDeleteAccount);
...
const presenceMiddlewares = {
    ...
    hardDeleteAccountFieldPresenceMiddleware,
